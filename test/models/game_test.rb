...
class GameTest < ActiveSupport::TestCase
  ...
  #   # assert_equal true,  game.can_escape? #b king B8
  #   # assert_equal true,  game.can_be_blocked? #b bishop D7
  #   assert_equal true,  game.can_be_captured? #b rook F5    
  # end
  ...
  #   assert_equal 12,    game.pieces.count
  #   assert_equal true,  game.check?('black')
  #   # test below obstructed pawn not seen
  #   # assert_equal false, game.check?('white')

  #   # assert_equal true,  game.checkmate?('black')
  #   # assert_equal false,  game.can_escape? #b king no moves
  #   # assert_equal false,  game.can_be_blocked? #b  no pieces can block
  #   assert_equal false, game.can_be_captured? #b can't capture    
  # end

  test "captured working" do
    game = FactoryGirl.create(:game)

    King.create(color: 'black', x_position: 7, y_position: 7, game: game)
    Rook.create(color: 'white', x_position: 6, y_position: 7, game: game)
    Rook.create(color: 'black', x_position: 6, y_position: 6, game: game)
